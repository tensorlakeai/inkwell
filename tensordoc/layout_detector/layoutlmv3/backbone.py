...
from tensordoc.layout_detector.dit.beit import (
    beit_base_patch16,
    beit_large_patch16,
    dit_base_patch16,
    dit_large_patch16,
)
from tensordoc.layout_detector.dit.deit import (
    deit_base_patch16,
    mae_base_patch16,
)
from tensordoc.layout_detector.layoutlmv3.layoutlmft.models.layoutlmv3 import (
    LayoutLMv3Model,
)
    ...
    def forward(self, x):
        ...
        if "layoutlmv3" in self.name:
            return self.backbone.forward(
                ...
                attention_mask=(
                    x["attention_mask"] if "attention_mask" in x else None
                ),
...
def build_vit_fpn_backbone_layoutlmv3(cfg, input_shape: ShapeSpec):
    """
